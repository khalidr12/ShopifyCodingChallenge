...
public class LetterBoard extends CenterLayout implements Observer {
    ...
    public void scale(float scaleX, float scaleY) {
        if (mInitialized) {
            mGridLineBg.setGridWidth((int) (100 * scaleX));
            mGridLineBg.setGridHeight((int) (100 * scaleY));
            mGridLineBg.setLineWidth((int) (1 * scaleX));

            mLetterGrid.setGridWidth((int) (100 * scaleX));
            mLetterGrid.setGridHeight((int) (100 * scaleY));
